...
<p>
    ...
    See how the <a href={pages.gnom.persistence.intro}>persistence system</a> deals with network objects and uses the GNOL to avoid making copies of the same network objects
